...
class StatusReport(APIView):
    ...
    def get(self, request):
        ...
        reporting_for_entities_response = reporting_for_entities.values("screen","status")
        submission_information = SubmissionInformation.objects.filter(**filters)
        submission_information_response = submission_information.values("screen","status")
        return Response(
            {
