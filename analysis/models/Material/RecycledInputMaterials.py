...
class RecycledInputMaterials(AbstractAnalysisModel, AbstractModel):
    ...
    total_weight_or_volume = models.DecimalField(max_digits=36, decimal_places=6)
    amount_of_material_recycled = models.DecimalField(max_digits=36, decimal_places=6)
    amount_of_recycled_input_material_used = models.DecimalField(
        max_digits=36, decimal_places=6
    )
