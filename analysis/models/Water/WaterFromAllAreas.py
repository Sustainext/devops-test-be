...
class WaterFromAllAreas(AbstractAnalysisModel, AbstractModel):
...
class ThirdPartyWaterDischargeFromAllAreas(AbstractAnalysisModel, AbstractModel):
    ...
    def __str__(self) -> str:
        return f"{self.third_party_discharge} - {self.water_unit}"
