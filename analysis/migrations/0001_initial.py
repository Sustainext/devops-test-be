    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantiy_gj', models.DecimalField(blank=True, decimal_places=5, max_digits=24, null=True)),
                ('quantity', models.DecimalField(blank=True, decimal_places=5, max_digits=24, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.DecimalField(choices=[('Milligram', 'Milligram'), ('Gram', 'Gram'), ('Kilogram', 'Kilogram'), ('Metric ton', 'Metric ton'), ('Pound', 'Pound'), ('US short ton', 'US short ton'), ('Milliliter', 'Milliliter'), ('Liter', 'Liter'), ('Fluid Ounce', 'Fluid Ounce'), ('Quart', 'Quart'), ('Gallon', 'Gallon'), ('Pint', 'Pint'), ('Cubic centimeter', 'Cubic centimeter'), ('Cubic decimeter', 'Cubic decimeter'), ('Cubic meter', 'Cubic meter'), ('Cubic foot', 'Cubic foot')], decimal_places=6, default='Milligram', max_digits=20)),
                ('unit', models.CharField(max_length=100)),
                ('index', models.PositiveIntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_of_product_sold', models.DecimalField(decimal_places=6, max_digits=10)),
                ...
                ('amount_of_recycled_material_used', models.DecimalField(decimal_places=6, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_weight_or_volume', models.DecimalField(decimal_places=6, max_digits=20)),
                ('amount_of_material_recycled', models.DecimalField(decimal_places=6, max_digits=20)),
                ('amount_of_recycled_input_material_used', models.DecimalField(decimal_places=6, max_digits=20)),
