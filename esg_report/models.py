...
class ESGReport(AbstractModel):
    ...
    corporate_entity = models.ForeignKey(Corporateentity, on_delete=models.SET_NULL, related_name='esg_reports',null=True,blank=True)
    framework = models.ForeignKey(Framework,on_delete=models.PROTECT, related_name='framework_esg_reports')
    client = models.ForeignKey(Client, on_delete=models.PROTECT, related_name='client_esg_reports')
    def __str__(self):
