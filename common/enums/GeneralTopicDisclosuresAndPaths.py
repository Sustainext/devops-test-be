GENERAL_DISCLOSURES_AND_PATHS = {
    ...
    "Restatement": [("Restatements of Information", "gri-general-restatements-2-4-a")],
    "Assurance": [
        (
    ...
    "Workforce-Employees": [
        ...
        (
            "Total number of employees - Non Guaranteed employees",
        ...
        ("Contextual information", "gri-general-workforce_employees-contextual-2-7d"),
        ("Employee Fluctuations", "gri-general-workforce_employees-fluctuations-2-7e"),
    ],
